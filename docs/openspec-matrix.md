...
| SPEC-003-CILIA-SPARK-BIND | SPEC-003 — CILIA / SPARK BIND | unspecified | unassigned | unspecified | **Title:** Vesper web Send + MCP bind **Status:** Proposed **Version:** 0.1.0 **Owner:** Liv HUB / Vesper integration **Audience:** Vesper web, Spark adapter, Cilia bus, MCP host/runtime, Keel Sentry, QA **Last updated:** 2026-09-17 **Related surfaces:** `cilia-bus`, `mcp-surface`, Vesper web, Keel Sentry |  |  | 0 | 0 | 40 | 0 | docs/openspec/SPEC-003-CILIA-SPARK-BIND.md |
