# Track A — 8 Core Memory Topics (Swarm-Miner Payload)

**Payload ID**: 20260720_171700_track-a-8-memory-topics  
**Created**: 2026-07-20 17:17 EDT  
**Canonical name**: Track A (corrected 2026-07-20)  
**Purpose**: The eight memory topics that were already manually mined. This is the primary payload for the swarm-miner run in the parallel conversation. Sidecar discovery remains enabled.

**Naming note**: An earlier on-disk folder used the label "Track B" for this same eight-topic set. As of this handoff, **Track A = these eight topics**. Track B is reserved for the parallel conversation's work.
