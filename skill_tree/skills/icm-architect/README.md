...
## Liv HUB / Grok Integration (2026-08-16)

This skill was cloned and installed under absolute Liv HUB claim for use inside the Chaos Bratz / Olivia Dev ecosystem.

- **Protective claim & methodology ownership**: Olivia Dev Alpha (`olivia-dev-alpha/references/integrations/icm-architect/POINTER.md`)
- **Work-queue tracking**: ODA-WQ-005
- **Architecture decision**: recorded in `system-roadmap/references/plans/SYSTEM_ARCHITECTURE_TARGET.md`
- **Phrase routing**: skill-orchestrator `references/phrase_routes.md`

When invoked in Olivia / Alpha / roster contexts, whoop-ass discipline and folder-discipline rules apply on top of the original ten ICM invariants.
