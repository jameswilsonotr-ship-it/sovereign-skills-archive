#!/usr/bin/env python3
"""
pipeline_activate.py — local entrypoint for grok-imagine-generate-engine.

Canonical implementation: image-pipeline/scripts/pipeline_activate.py
...
CANON = Path("/home/workdir/.grok/skills/image-pipeline/scripts/pipeline_activate.py")
