#!/usr/bin/env python3
"""
list_apply.py — local entrypoint for grok-imagine-generate-engine.

Canonical implementation: image-pipeline/scripts/list_apply.py
...
CANON = Path("/home/workdir/.grok/skills/image-pipeline/scripts/list_apply.py")
