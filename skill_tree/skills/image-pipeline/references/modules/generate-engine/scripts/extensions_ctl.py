#!/usr/bin/env python3
"""
extensions_ctl.py — local entrypoint for grok-imagine-generate-engine.

Canonical implementation: image-pipeline/scripts/extensions_ctl.py
...
CANON = Path("/home/workdir/.grok/skills/image-pipeline/scripts/extensions_ctl.py")
