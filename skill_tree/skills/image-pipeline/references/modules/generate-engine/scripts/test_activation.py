#!/usr/bin/env python3
"""
test_activation.py — local entrypoint for grok-imagine-generate-engine.

Canonical implementation: image-pipeline/scripts/test_activation.py
...
CANON = Path("/home/workdir/.grok/skills/image-pipeline/scripts/test_activation.py")
