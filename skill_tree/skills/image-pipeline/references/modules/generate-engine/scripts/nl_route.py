#!/usr/bin/env python3
"""
nl_route.py — local entrypoint for grok-imagine-generate-engine.

Canonical implementation: image-pipeline/scripts/nl_route.py
...
CANON = Path("/home/workdir/.grok/skills/image-pipeline/scripts/nl_route.py")
